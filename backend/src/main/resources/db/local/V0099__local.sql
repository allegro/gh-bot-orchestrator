...
INSERT INTO public.workflow_json_path_matchers (id, filter_id, path, regex) VALUES (1010, 1005, '$.repository.name', '(pull-request-manager|skycaptcha)-config') ON CONFLICT (id) DO NOTHING;
